...
/** A contiguous run of block numbers, inclusive at both ends. */
...
/** The inverse: [1,2,3,7] becomes "1-3, 7". Keeps long selections readable. */
export function nommersNaReekse(ids: number[]): Reeks[] {
...
export function reeksTeks(r: Reeks): string {
