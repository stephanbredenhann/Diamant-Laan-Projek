...
namespace DiamantLaan.Api.Migrations
{
    ...
    [Migration("20260817101600_AddPendingBlockNotificationStatuses")]
    partial class AddPendingBlockNotificationStatuses
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DiamantLaan.Api.Models.AdminSaveSnapshot", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<int?>("CreatedProgressImageId")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<string>("ReplacedImagesJson")
                        .IsRequired()
                        .HasColumnType("TEXT");

                    b.Property<string>("SquareStatusJson")
                        .IsRequired()
                        .HasColumnType("TEXT");

                    b.Property<string>("UndoBatchId")
                        .IsRequired()
                        .HasColumnType("TEXT");

                    b.HasKey("Id");

                    b.HasIndex("UndoBatchId");

                    b.HasIndex("ConsumedAt", "CreatedAt");

                    b.ToTable("AdminSaveSnapshots");
                });

            modelBuilder.Entity("DiamantLaan.Api.Models.PasswordResetOtp", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("DiamantLaan.Api.Models.PendingBlockNotification", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("TEXT");

                    b.Property<DateTime>("FirstQueuedAt")
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("PendingBlockNotifications");
                });

            modelBuilder.Entity("DiamantLaan.Api.Models.PendingEmail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("DiamantLaan.Api.Models.ProfileChangeLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("DiamantLaan.Api.Models.Purchase", b =>
                {
                    ...
                    b.Property<DateTime?>("ClaimEmailSentAt")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("DiamantLaan.Api.Models.SiteSettings", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<bool>("ShowTotalRaised")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("DiamantLaan.Api.Models.User", b =>
                {
                    ...
                    b.Property<bool>("CertificateIndividual")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<bool>("IsOraniaBewegingMember")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<bool>("ReceiveBlockProgressEmails")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
